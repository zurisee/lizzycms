...
$this->addMacro($macroName, function () {
    ...
    if (!isset($GLOBALS['lizzy']['get-data'][ $GLOBALS['lizzy']['pagePath'] ])) {
        $GLOBALS['lizzy']['get-data'][ $GLOBALS['lizzy']['pagePath']] = 0;
    }
    $inx = $GLOBALS['lizzy']['get-data'][$GLOBALS['lizzy']['pagePath']];
    ...
    if ($dataSelector === 'next') {
        ...
        if ($inx < $n - 1) {
            $inx = $inx + 1;
            $GLOBALS['lizzy']['get-data'][$GLOBALS['lizzy']['pagePath']]++;
        }
